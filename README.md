...
* Published curated resources ([awesome-vibecoding](https://github.com/roboco-io/awesome-vibecoding), ⭐166) serving as the definitive guide for AI-driven development
...
* Built cost-optimized serverless AI infrastructure ([Serverless OpenClaw](https://github.com/serithemage/serverless-openclaw), ⭐187) running AI agents on AWS at ~$1/month
...
* Built developer productivity tools such as [hwp2md](https://github.com/roboco-io/hwp2md) (⭐110, HWP→Markdown converter), [buildcop](https://github.com/roboco-io/buildcop) (test failure analysis), and [Claude Code plugins](https://github.com/roboco-io/plugins)
...
* **TypeScript** — Serverless AI agents ([serverless-openclaw](https://github.com/serithemage/serverless-openclaw) ⭐187), code assistants, demo apps
* **Go** — Document conversion tools ([hwp2md](https://github.com/roboco-io/hwp2md) ⭐110), GitHub automation CLI ([ghx-cli](https://github.com/roboco-io/ghx-cli) ⭐5), test analysis ([buildcop](https://github.com/roboco-io/buildcop))
* **Python** — AI research pipelines ([serverless-autoresearch](https://github.com/roboco-io/serverless-autoresearch) ⭐18), S3 benchmark experiments ([s3-experiments](https://github.com/roboco-io/s3-experiments) ⭐8), MCP servers
...
* **Create and maintain open-source tools** demonstrating Vibe Coding principles — Serverless OpenClaw (⭐187), hwp2md (⭐110), awesome-vibecoding (⭐166)
* **Build serverless AI infrastructure** achieving ~$1/month operational cost for AI agent workloads ([Serverless OpenClaw](https://github.com/serithemage/serverless-openclaw), ⭐187); presented at **AWS Unicorn Day 2026**
...
* **Develop innovative development tools** like Claude Code plugins, MCP servers ([botmadang-mcp](https://github.com/serithemage/botmadang-mcp)), Solar Code CLI, and testing tools ([buildcop](https://github.com/roboco-io/buildcop))
...
### [awesome-vibecoding](https://github.com/roboco-io/awesome-vibecoding) ⭐ 166 stars
...
AI-DLC (AI-Driven Development Life Cycle) Claude Code plugin. Adaptive workflow steering rules that integrate AI-DLC methodology directly into AI coding agents. See also [aidlc-workflows](https://github.com/roboco-io/aidlc-workflows) for the underlying workflow rules.

### [roboco-cli](https://github.com/roboco-io/roboco-cli) ⭐ 10
AI-native development scaffolding system for vibe coding with Claude Code. Generates project structures optimized for AI-driven development workflows with pre-configured CLAUDE.md, agents, and best-practice templates.
...
- **[ttimes-vibecoding-conference](https://github.com/roboco-io/ttimes-vibecoding-conference)** ⭐ 19 - Live demo Todo app for Vibe Coding workshops
- **[vibecoding-demo](https://github.com/roboco-io/vibecoding-demo)** ⭐ 34 - TypeScript demonstration project for Vibe Coding fundamentals
...
- **[s3-experiments](https://github.com/roboco-io/s3-experiments)** ⭐ 8 - What else can S3 do? Exploring S3 as KV Store, Event Store, RDBMS, and more — with benchmarks and honest tradeoffs
...
- **[hwp2md](https://github.com/roboco-io/hwp2md)** ⭐ 110 - Tool for converting HWP (Hancom Word Processor) documents to Markdown
...
- **[plugins](https://github.com/roboco-io/plugins)** ⭐ 8 - Claude Code plugin collection - Skills, Commands, Agents, Hooks
...
### AI & Research
- **[serverless-autoresearch](https://github.com/roboco-io/serverless-autoresearch)** ⭐ 18 - Parallel evolution pipeline for Karpathy's autoresearch on SageMaker Spot Training (H100). 10x faster with HUGI pattern
...
### [Serverless OpenClaw](https://github.com/serithemage/serverless-openclaw) ⭐ 187 stars
Run OpenClaw AI agent on-demand on AWS serverless infrastructure with Web UI and Telegram interfaces. Cost-optimized architecture targeting ~$1/month, presented at AWS Unicorn Day 2026.
...
### [AWSCertifiedSolutionsArchitectUnofficialStudyGuide](https://github.com/serithemage/AWSCertifiedSolutionsArchitectUnofficialStudyGuide) ⭐ 1,321
